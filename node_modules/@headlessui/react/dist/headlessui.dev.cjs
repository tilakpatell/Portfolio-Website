...
function OptionsFn2(props, ref) {
  ...
  let frozenValue = useFrozenData(shouldFreeze, data.value);
  let isSelected = useEvent((compareValue) => data.compare(frozenValue, compareValue));
  let selectedOptionIndex = (0, import_react73.useMemo)(() => {
    var _a3;
    if (anchor == null)
      return null;
...
function PopoverFn(props, ref) {
  ...
  return /* @__PURE__ */ import_react75.default.createElement(MainTreeProvider, { node: mainTreeNode }, /* @__PURE__ */ import_react75.default.createElement(FloatingProvider, null, /* @__PURE__ */ import_react75.default.createElement(PopoverPanelContext.Provider, { value: null }, /* @__PURE__ */ import_react75.default.createElement(PopoverContext.Provider, { value: reducerBag }, /* @__PURE__ */ import_react75.default.createElement(PopoverAPIContext.Provider, { value: api }, /* @__PURE__ */ import_react75.default.createElement(CloseProvider, { value: close }, /* @__PURE__ */ import_react75.default.createElement(
    OpenClosedProvider,
    {
...
function GroupFn2(props, ref) {
  ...
  let theirProps = props;
  let ourProps = { ref: groupRef };
  return /* @__PURE__ */ import_react75.default.createElement(MainTreeProvider, null, /* @__PURE__ */ import_react75.default.createElement(PopoverGroupContext.Provider, { value: contextBag }, render({
    ourProps,
    theirProps,
    slot,
...
function PanelFn4(props, ref) {
  ...
  if (!selected && ((_c = theirProps.unmount) != null ? _c : true) && !((_d = theirProps.static) != null ? _d : false)) {
    return /* @__PURE__ */ import_react80.default.createElement(Hidden, { "aria-hidden": "true", ...ourProps });
  }
  return render({
    ourProps,
    theirProps,
